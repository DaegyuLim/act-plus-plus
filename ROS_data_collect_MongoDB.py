...
class DataRecorder:
    ...
    def data_collect_MongoDB(self):
        ...
        camera_data_list = []
        for cam_name in self.camera_names:
            # This should be replaced with a image file path (URL)
            self.total_data[f'/observations/images/{cam_name}'] = getattr(self, f'{cam_name}_image')
            
            ###
            image_url = f'/observations/images/{cam_name}'
        ...
        ############## save data ###########################
        # collection.insert_one(self.total_data)
        # code here feat.NJ
